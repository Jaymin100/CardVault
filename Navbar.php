<nav style="background-color: #f8f8f8; padding: 10px 20px; box-shadow: 0 2px 5px rgba(0,0,0,0.05); position: fixed; top: 0; width: 100%; z-index: 1000;">
  <ul style="list-style: none; display: flex; gap: 30px; margin: 0; padding: 0; align-items: center;">
    ...
    <li style="margin-left: auto; font-weight: bold;">TEMP_USERNAME</li>
  </ul>
</nav>
